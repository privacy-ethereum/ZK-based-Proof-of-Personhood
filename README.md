...
|-----------|------|----------|---------------|
| [zkid](https://github.com/zkmopro/zkid) | ZK circuits (`cert_chain_rs4096`, `device_sig_rs2048`), Spartan2/Hyrax prover, Circom witness calculator | [PSE zkID](https://github.com/privacy-ethereum/zkID) | [`b4f151d`](https://github.com/zkmopro/zkid/commit/b4f151dd20339cbec9f3b89f40497b6aca6bca55) |
...
| [moica-revocation-smt](https://github.com/moven0831/moica-revocation-smt) | MOICA CRL → Poseidon SMT → REST/gRPC proofs → on-chain root (Arbitrum Sepolia `0xc461…AFFA`); binary snapshots for offline client use | — | [`34b5cfe`](https://github.com/moven0831/moica-revocation-smt/commit/34b5cfe53b0f3a2f1f8561d376c676b1ca4239a5) |
