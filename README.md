...
| [go-zkid-verifier](https://github.com/privacy-ethereum/go-zkid-verifier) | Go backend: challenge/nonce, ZK proof verification (FFI → Rust), nullifier dedup, SMT root and issuer-cert trust checks | — | [`16fc609`](https://github.com/privacy-ethereum/go-zkid-verifier/commit/16fc6098c7e532653965157936b6c87d56c7ec2d) |
| [moica-revocation-smt](https://github.com/moven0831/moica-revocation-smt) | MOICA CRL → Poseidon SMT → REST/gRPC proofs → on-chain root (Arbitrum Sepolia `0xc461…AFFA`); binary snapshots for offline client use | — | [`1d0b741`](https://github.com/moven0831/moica-revocation-smt/commit/1d0b7410d5ef4d59ca649408e634a639ef254729) |
| [OpenACSwift](https://github.com/privacy-ethereum/OpenACSwift) | Swift package (iOS 16+): on-device proof generation for x509 cert circuits (`proveCertChainRs4096`, `proveUserSigRs2048`), offline SMT revocation check, circuit-input preparation. Reusable by any iOS app built around an x509 certificate-based identity scheme. | [mopro](https://github.com/zkmopro/mopro) | [`b5344ad`](https://github.com/privacy-ethereum/OpenACSwift/commit/b5344ad9032b6c76f4825b0ba9b4c8d80660fd9e) |
| [OpenACKotlin](https://github.com/privacy-ethereum/OpenACKotlin) | Kotlin/Android library (JNI): on-device proof generation for x509 cert circuits (`proveCertChainRs4096`, `proveUserSigRs2048`), circuit-input preparation. Reusable by any Android app built around an x509 certificate-based identity scheme. | [mopro](https://github.com/zkmopro/mopro) | [`1642904`](https://github.com/privacy-ethereum/OpenACKotlin/commit/16429044734d0d7b812b7ef5128d88c1abe79768) |
| [OpenACExampleApp](https://github.com/privacy-ethereum/OpenACExampleApp) | iOS sample app: TW FidO / MOICA auth, circuit-key download, Groth16 ZK proof generation (`proveCertChainRs4096`, `proveUserSigRs2048`), and `POST /link-verify` submission | [OpenACSwift](https://github.com/privacy-ethereum/OpenACSwift) | [`11143a9`](https://github.com/privacy-ethereum/OpenACExampleApp/commit/11143a91bd0460d8dbbe1c11dc555704778574eb) |
| [OpenACAndroidExample](https://github.com/privacy-ethereum/OpenACAndroidExample) | Android sample app (Jetpack Compose): TW FidO / MOICA auth, circuit-key download, ZK proof generation (`proveCertChainRs4096`, `proveUserSigRs2048`), and `POST /link-verify` submission | [OpenACKotlin](https://github.com/privacy-ethereum/OpenACKotlin) | [`abbd0bb`](https://github.com/privacy-ethereum/OpenACAndroidExample/commit/abbd0bba3a278a23bdf6e5728d1e880a490347a2) |
